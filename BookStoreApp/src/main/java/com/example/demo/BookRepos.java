...
public class BookRepos {
	...
	public boolean updateBook(Book b) {
		int x=jtemp.update("update Book set BName=?,BAuthor=?,BCategory=?,BPrice=? where BID=? ",b.getBname(),b.getBauthor(),b.getBcategory(),b.getBprice(),b.getBid());
	...
	public Book selectBook(Book b) {
		Book b1=jtemp.queryForObject("select * from Book where BID=?",new Object[] {b.getBid()},new BeanPropertyRowMapper<>(Book.class));
		return b1;
	}
